...
try:
    ...
    # For newer timm versions (0.9.x, 1.0.x)
    try:
        from timm.layers import str_to_interp_mode as _pil_interp
    except ImportError:
        from timm.data.transforms import str_to_interp_mode as _pil_interp
